...
class GenerateWords(luigi.Task):
    ...
    def output(self):
        return luigi.LocalTarget(f"{PATH_OUTPUT}/kubernetes/words.txt")
...
class CountLetters(luigi.Task):
    # ========================================
    # This will execute on a Kubernetes cluster!
    # ========================================
    ...
    def output(self):
        return luigi.LocalTarget(f"{PATH_OUTPUT}/kubernetes/letter_counts.txt")
